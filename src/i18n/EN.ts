const translation: Record<TextTag, string> = {
    ...
    "Alert::LoadUrl::InputScriptURL": "InputScriptURL",
    "Alert::Confirm": "Confirm",
    "Alert::Cancel": "Cancel",
    "Alert::LoadUrl::PleaseInputCorrectUrl": "PleaseInputCorrectUrl url, which should be like 'https://example.com/script.user.js'",
    "Alert::Title": "Alert",
