const translation: Map<string, string> = new Map<string, string>([
    ...
    ["MenuItem::Script::Refresh Script", "Refresh Script"],
    ["Alert::LoadUrl::Input script URL", "Input script URL"],
    ["Alert::LoadUrl::Confirm", "Confirm"],
    ["Alert::LoadUrl::Cancel", "Cancel"],
    ["Alert::LoadUrl::Please input Correct", "Please input correct url"]
]);
